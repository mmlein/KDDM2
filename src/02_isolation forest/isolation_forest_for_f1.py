...
def algorithm(dataset_complete: pd.DataFrame, cont: float = 0.05, max_feat: int = 1.0,
    ...
    for letter in alphabet:
        ...
        # Prepare dataset
        data_letter, letter_train, letter_test = prepare_dataset(letter, dataset_complete, test_prob=0.2)
    ...
    if write_to_csv == True:
        filename = "C:/Users/Florentina/Documents/Uni CSS/3. Semester/Results_ifor/Ifor_3std_4,16%_{}_{}_{}_{}_{}.csv".format(cont, 
            max_feat, max_samp, n_est, random_state)
...
def cross_validation(params: dict, dataset_complete: pd.DataFrame,
    ...
    if write_to_csv == True:
        path_abs =  "C:/Users/Florentina/Documents/Uni CSS/3. Semester/Results_ifor/Ifor_abs.csv"
        path_rel =  "C:/Users/Florentina/Documents/Uni CSS/3. Semester/Results_ifor/Ifor_rel.csv"
